...
chunk_size = 450
database_out = "/data/finlm_sequences/finlm_chunks_450.sqlite"
...
if "esg_reports" in table_names:
    ...
    esg_chunker = EsgReportChunker("/data/esg_reports/Raw_pdf_data.sqlite", "Raw_pdf_data")
...
if "ssrn_papers" in table_names:
    ...
    ssrn_chunker = SSRNChunker("/data/SSRN_Text_Data/ssrn_papers.sqlite", "raw_texts")
